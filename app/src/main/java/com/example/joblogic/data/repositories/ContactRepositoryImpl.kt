...
class ContactRepositoryImpl @Inject constructor(
    ...
    private val jobLogicRemoteDataSource: JobLogicRemoteDataSource) : ContactRepository {
    override suspend fun getContactList(): Either<Failure, List<Contact>> = withHandlingException(ioDispatcher) {
